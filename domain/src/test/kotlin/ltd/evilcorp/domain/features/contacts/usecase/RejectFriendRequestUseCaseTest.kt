...
class RejectFriendRequestUseCaseTest {
    ...
    @Test
    fun `reject friend request deletes request, does not add contact`() = runTest {
        // Arrange
        ...
        val useCase = RejectFriendRequestUseCase(manager)
        ...
        // Assert
        // 1. Check contact not added
        assertFalse(contactRepo.exists(req.publicKey))

        // 2. Check request deleted
